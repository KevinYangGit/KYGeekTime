...
class KYFakeData {
    ...
    static func createDeals() -> [KYDeal] {
        ...
        deals = KYFakeData.createProducts().map {
            KYDeal(product: $0, progress: 1)
        }
        return deals
    }
}
